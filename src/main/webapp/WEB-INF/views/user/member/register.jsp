												...
												<div class="panel-heading">
													<h4 class="panel-title">
														<a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion-1" href="#collapse-One">
															<label><input type="checkbox" name="subsciption" value="이용약관" />everywhere 이용 약관에 대한 동의 (필수)</label>
														</a>
													</h4>
												</div>
													...
													<div class="panel-body">
														<div class="row">
															<div class="col-md-12" style="font:8px;">
																<pre-scrollable>
																	제 1 조(목적) 이 약관은 (주)3성(이하 “회사”라 합니다)가 제공하는 여행정보 공유서비스 
																	‘에브리웨얼'(‘Everywhere’) 웹 서비스, 모바일 어플리케이션 등 관련 제반 서비스(이하 “서비스”라 합니다)의 이용과 관련하여 회사와 회원과의 권리, 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.<br/> 
																	제 2 조(정의) 이 약관에서 사용하는 용어의 정의는 다음과 같습니다.<br/>
																	1. "회원"이라 함은 "회사"의 "서비스"에 접속하여 이 약관에 따라 "회사"와 이용계약을 체결하고 "회사"가 제공하는 "서비스"를 이용하는 고객을 말합니다.<br/>
																	2. "서비스"라 함은 구현되는 단말기(PC, 휴대형단말기 등의 각종 유무선 장치를 포함)와 상관없이 "회원"이 이용할 수 있는 위시빈 관련 제반 서비스를 의미합니다.<br/>
																	...
																	5. "게시물"이라 함은 회원이 서비스를 이용함에 있어 서비스상에 게시한 부호 · 문자 · 음성 · 음향 · 화상 · 동영상 등의 정보 형태의 글, 사진, 동영상 및 각종 파일과 링크 등을 의미합니다.<br/> 
																	...
																	8. 이 약관에서 정의되지 않은 용어는 관련법령이 정하는 바에 따릅니다.<br/>
																	제 3 조(약관의 게시와 개정)<br/>
																	...
																	4. "회사"가 전항에 따라 공지하면서 회원에게 30일 기간 이내에 의사표시를 하지 않으면 승인한 것으로 본다는 뜻을 명확하게 공지하였음에도 회원이 명시적으로 거부의사를 밝히지 않은 경우에 회원이 개정약관에 동의한 것으로 봅니다.<br/> 
																	5. "회원"이 개정약관에 동의하지 않는 경우 회사는 개정약관의 내용을 적용할 수 없으며, 이 경우 회원은 이용계약을 해지할 수 있습니다. 다만, 기존 약관을 적용할 수 없는 특별한 사정이 있는 경우에는 회사는 이용계약을 해지할 수 있습니다.<br/> 
																	제 4 조(약관의 해석)<br/>
																	...
																	라. 이용자의 귀책사유로 인하여 승인이 불가능하거나 기타 규정한 제반 사항을 위반하며 신청하는 경우<br/> 
																	...
																	3. 제 2 항의 변경사항을 "회사"에 알리지 않아 발생한 불이익에 대하여 "회사"는 책임지지 않습니다.<br/> 
																	제 7 조(개인정보보호 의무)<br/>
																	1. "회사"는 "정보통신망법" 등 관계 법령이 정하는 바에 따라 "회원"의 "개인정보"를 보호하기 위해 노력합니다. "개인정보"의 보호 및 사용에 대해서는 관련법 및 "회사"의 개인정보보호정책이 적용됩니다. 다만, "회사"의 공식 사이트
																	이외의 링크된 사이트에서는 "회사"의 개인정보보호정책이 적용되지 않습니다.<br/> 
																	제 8 조(제8조("회원"의 "아이디" 및 "비밀번호"의 관리에 대한 의무)<br/> 
																	...
																	4. 제 3 항의 경우에 해당 "회원"이 "회사"에 그 사실을 통지하지 않거나, 통지한 경우에도 "회사"의 안내에 따르지 않아 발생한 불이익에 대하여 "회사"는 책임지지 않습니다.<br/> 
																	제 9 조("회원"에 대한 통지)<br/> 
																	1. "회사"가 "회원"에 대한 통지를 하는 경우 본 약관에 별도 규정이 없는 한 "회원"이 지정한 전자우편주소, 서비스 내 전자메모 및 쪽지 등으로 할 수 있습니다.<br/> 
																	2. "회사"는 "회원" 전체에 대한 통지의 경우 7 일 이상 "회사"의 게시판에 게시함으로써 제 1 항의 통지에 갈음할 수 있습니다.<br/> 
																	제 10 조 ("회사"의 의무)<br/> 
																	...
																	회원이 제기한 의견이나 불만사항에 대해서는 게시판을 활용하거나 전자우편 등을 통하여 "회원"에게 처리과정 및 결과를 전달합니다.<br/> 
																	제 11 조(서비스 이용의 중지 또는 계약의 해지)<br/>
																	...
																	2. "회원"은 관계법, 본 약관의 규정, 이용안내 및 "서비스"와 관련하여 공지한 주의사항, "회사"가 통지하는 사항 등을 준수하여야 하며,
																	기타 "회사"의 업무에 방해되는 행위를 하여서는 안 됩니다.<br/>
																	제 12 조(서비스의 제공 등)<br/>
																	1. 회사는 회원에게 아래와 같은 서비스를 제공합니다.<br/> 
																	가. 위시빈 : 여행 정보 또는 자료의 관리/저장/공유/인쇄 및 출력을 위한 여행관련 정보 서비스 <br/>
																	...
																	5. "회사"는 서비스의 제공에 필요한 경우 정기점검을 실시할 수 있으며, 정기점검시간은 서비스제공화면에 공시한 바에 따릅니다.<br/> 
																	제 13 조(서비스의 변경)<br/>
																	...
																	이때, "회사"는 동의를 거절한 "회원"에 대해서는 변경 전 서비스를 제공합니다. 다만, 그러한 서비스 제공이 불가능할 경우 해당 서비스의 제공을 중지하거나 계약을 중단할 수 있으며 이 경우 환불은 제19조 2항에 따라 진행됩니다.<br/>
																	...
																	4. "회사"는 "서비스"의 운영과 관련하여 서비스 화면, 홈페이지, 전자우편 등에 광고를 게재할 수 있습니다. 광고가 게재된 전자우편을 수신한 "회원"은 수신거절을 "회사"에게 할 수 있습니다.<br/>
																	제 15 조(게시물의 저작권)<br/>
																	...
																	원저작자로부터의 요청이 있을 경우 해당 게시물을 “회원”에게 통지하지 않고 삭제 혹은 변경할 수 있으며, 이 경우 “회원”은 저작권 침해에 대한 민형사상의 책임을 질 수 있습니다.<br/>
																	제 16 조(게시물의 관리)<br/> 
																	...
																	3. 본 조에 따른 세부절차는 "정보통신망법" 및 "저작권법"이 규정한 범위 내에서 회사가 정한 게시중단요청서비스에 따릅니다.<br/>
																	제 17 조(위치기반서비스의 내용 및 요금)<br/>
																	1. 회사는 위치정보사업자로부터 제공받은 위치정보수집대상의 위치정보 및 상태 정보를 이용하여 다음과 같은 내용의 서비스를 제공합니다.<br/>
																	가. 이용자의 현재 위치 또는 특정 위치를 지도 이미지 상에 표시해주는 서비스<br/> 
																	나. 이용자의 현재 위치 또는 특정 위치에서 근접한 관광지, 숙박시설, 음식점, 쇼핑시설 등 여행 명소 정보 제공 및 검색 서비스<br/>
																	다. 이용자가 생성하는 컨텐츠(사진, 동영상, 서비스 내 게시물 등)에 기록되거나 이에 결합된 위치정보를 활용하여 새로운 컨텐츠를 생성하고 공유하는 서비스<br/>
																	2. 회사는 본조 제 1 항의 회사가 제공하는 서비스는 기본적으로 무료입니다. 단, 무선 서비스 이용 시 발생하는 데이터 통신료는 별도이며, 이는 이용자가 가입한 각 이동통신사의 정책에 따릅니다.<br/> 
																	제 18 조(위치정보 수집방법)<br/>
																	“회사”는 아래 각호에 명시된 바와 같은 방식으로 개인위치정보를 수집합니다.<br/>
																	가. 휴대폰 단말기를 이용한 기지국 기반(Cell ID 방식)의 실시간 위치정보 수집<br/> 
																	나. GPS 칩이 내장된 전용 단말기를 통해 수집되는 GPS 정보를 통한 위치정보 수집<br/> 
																	다. Wi-Fi 칩이 내장된 전용 단말기를 통해 수집되는 Wi-Fi 정보를 통한 위치정보 수집<br/>
																	제 19 조(개인위치정보주체의 권리)<br/>
																	...
																	3. 개인위치정보주체는 회사에 대해 아래 자료의 열람 또는 고지를 요구할 수 있고, 당해 자료에 오류가있는 경우에는 그 정정을 요구할 수 있습니다. 이 경우 회사는 정당한 이유 없이 요구를 거절하지 아니합니다.<br/>
																	가. 개인위치정보주체에 대한 위치정보 이용·제공사실 확인자료<br/>
																	나. 개인위치정보주체의 개인위치정보가 위치정보의 보호 및 이용 등에 관한 법률 또는 다른 법률의 규정에 의해 제3자에게 제공된 이유 및 내용<br/>
																	...
																	5. 개인위치정보주체는 제 1 항 내지 제 4 항의 권리행사를 위해 회사 소정의 절차를 통해 회사에 요구할수 있습니다.<br/>
																	제 20 조(위치정보의 이용 및 제공사실 확인자료의 보유 및 이용기간)<br/>
																	“회사”는 위치정보보호법 제16조 제2항에 근거하여 회원에 대한 위치정보의 수집 이용 제공사실 확인자료를 위치보정보시스템에 자동으로 기록하며, 이를 기록 시점으로부터 6개월 동안 보존합니다.<br/>
																	제 21 조(위치정보관리책임자의 지정)<br/>
																	1. "회사"는 위치정보를 적절히 관리·보호하고 개인위치정보주체의 불만을 원활히 처리할 수 있도록 실질적인 책임을 질 수 있는 지위에 있는 자를 위치정보관리책임자로 지정해 운영합니다.<br/>
																	2. 위치정보관리책임자의 구체적인 사항은 본 약관의 부칙에 따릅니다.<br/>
																	제 22 조(권리의 귀속)<br/>
																	...
																	위반한 경우에는 즉시 계약해지를 할 수 있습니다. 본 항에 따른 계약해지 시 서비스 이용을 통해 획득한 혜택 등도 모두 소멸되며, 회사는 이에 대해 별도로 보상하지 않습니다.<br/>
																	...
																	5. 본 조에 따라 서비스 이용을 제한하거나 계약을 해지하는 경우에는 "회사"는 제 9 조["회원"에 대한 통지]에 따라 통지합니다.<br/> 
																	6. "회원"은 본 조에 따른 이용제한 등에 대해 "회사"가 정한 절차에 따라 이의신청을 할 수 있습니다. 이때 이의가 정당하다고 회사가 인정하는 경우 회사는 즉시 서비스의이용을 재개합니다.<br/> 
																	제 25 조(책임제한)<br/> 
																	...
																	제 26 조(준거법 및 재판관할)<br/>
																	1. "회사"와 "회원" 간 제기된 소송은 대한민국법을 준거법으로 합니다.<br/>
																	2. "회사"와 "회원"간 발생한 분쟁에 관한 소송은 민사소송법 상의 관할법원에 제소합니다.<br/>
																	부칙 1. 이 약관은 2015 년 12 월 29 일부터 적용됩니다.<br/> 
																	2. 위치정보관리책임자는 2014 년 10 월을 기준으로 다음과 같이 지정합니다.<br/>
																	성 명 : 배성욱<br/> 
																	직 책 : (주)3성 대표<br/> 
																	연락처 : 010-4772-0727<br/> 
																	이메일 : admin@everywhere.com<br/> 
																	주 소 : 성남시 분당구 삼평동 U-Space 2차 8층 (주)3성<br/>
																</pre-scrollable>
															</div>
														</div>
													</div>
										...
										<div class="panel panel-default">
											...
											<div id="collapse-Two" class="panel-collapse collapse">
												<div class="panel-body">
													<div class="row">
														<div class="col-md-12" style="font:8px;">
															정보통신망법 규정에 따라, 위시빈에 회원가입 신청하시는 이용자들께, 수집하는 개인정보의 항목, 개인정보의 수집 및 이용목적, 개인정보의 보유 및 이용기간에 대하여 안내 드리오니, 자세히 읽은 후 동의하여 주시기 바랍니다.<br/>
															1. 수집하는 필수 개인정보의 항목<br/> 
															회사는 회원가입, 고객 상담 및 각종 서비스의 제공을 위하여 아래와 같이 개인정보를 수집하고 있습니다.<br/>
															...
															2. 개인정보의 수집 및 이용 목적 회사는 다음의 목적을 위하여 개인정보를 처리합니다. 처리하고 있는 개인정보는 다음의 목적 이외의 용도로는 이용되지 않으며, 이용 목적이 변경되는 경우에는 별도의 동의를 받는 등 필요한 조치를 이행할 예정입니다.<br/>
															...
															3. 개인정보의 보유 및 이용 기간 회사는 법령에 따른 개인정보 보유·이용기간 또는 이용자로부터 개인정보를 수집시에 동의 받은 개인정보 보유·이용기간 내에서 개인정보를 처리·보유합니다. 각각의 개인정보 처리 및 보유 기간은 다음과 같습니다.<br/> 
															...
															- 소비자의 불만 또는 분쟁처리에 관한 기록 보존 이유 : 전자상거래 등에서의 소비자보호에 관한 법률 보존 기간 : 5년<br/>
															- 웹사이트 방문 기록 보존 이유 : 통신비밀보호법 보존 기간 : 3개월<br/>
														</div>
													</div>
												</div>
											</div>
