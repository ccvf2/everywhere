...
<body onload="initialize()">
	<div id="addSpotModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
									...
									<div class="row">
										...
										<div class="col col-5" style="float: right">
											<section>
												...
												<img id="preview" style="border:1px solid #D7D7D7; width : 300px; height:300px;" alt="image"/>
											</section>
										</div>
									</div>
								</fieldset>
	...
	<script type="text/javascript">
		$(function() { 
			...
			$('#addSpotModal').on('hide.bs.modal', function() {
				$('#addSpotModal').remove();
			})
		});
	</script> 
